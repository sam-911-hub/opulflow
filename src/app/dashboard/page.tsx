...
export default function DashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black">
      {/* Custom Header */}
      <header className="bg-gray-800/90 backdrop-blur-sm shadow-sm border-b border-gray-700/50">
        <div className="px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-xl font-bold text-white tracking-tight">OpulFlow</h1>
                <p className="text-xs text-gray-400 -mt-1">Human-Powered Marketing</p>
              </div>
            </div>
      ...
      {/* Main Content - Custom Dashboard Style */}
      <main className="flex-1 p-6">
        <div className="max-w-full">
          {/* Welcome Section */}
          <div className="mb-8 bg-gray-800/70 backdrop-blur-sm rounded-2xl p-6 border border-gray-700/50 shadow-sm">
            <div className="flex items-center space-x-3 mb-3">
              ...
              <div>
                ...
                <p className="text-gray-300 text-sm">Ready to boost your social presence?</p>
              </div>
            </div>
            <p className="text-gray-200 leading-relaxed">Manage your authentic marketing campaigns, track real human engagement, and grow your brand organically.</p>
          </div>
          ...
          <div className="mb-8 grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-1 space-y-4">
              <div className="bg-gray-800/90 backdrop-blur-sm rounded-xl shadow-sm border border-gray-700/50 p-6 hover:shadow-lg transition-all duration-200">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-semibold text-gray-200 uppercase tracking-wide">Campaigns</p>
              ...
              <div className="bg-gray-800/90 backdrop-blur-sm rounded-xl shadow-sm border border-gray-700/50 p-6 hover:shadow-lg transition-all duration-200">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-semibold text-gray-200 uppercase tracking-wide">In Progress</p>
                    <p className="text-3xl font-bold text-gray-300 mt-1">{stats.pendingOrders}</p>
                    <p className="text-xs text-gray-400 mt-1">Orders being processed</p>
                  </div>
              ...
              <div className="bg-gray-800/90 backdrop-blur-sm rounded-xl shadow-sm border border-gray-700/50 p-6 hover:shadow-lg transition-all duration-200">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-semibold text-gray-200 uppercase tracking-wide">Credits</p>
                    <p className="text-3xl font-bold text-white mt-1">∞</p>
                    <p className="text-xs text-gray-400 mt-1">Pay-as-you-go system</p>
                  </div>
            ...
            <div className="lg:col-span-2 space-y-4">
              <div className="bg-gray-800/90 backdrop-blur-sm rounded-xl shadow-sm border border-gray-700/50 p-6 hover:shadow-lg transition-all duration-200">
                <div className="flex items-center space-x-3 mb-4">
                  ...
                  <h3 className="text-lg font-bold text-white tracking-tight">Order Status Overview</h3>
                </div>
              ...
              <div className="bg-gray-800/90 backdrop-blur-sm rounded-xl shadow-sm border border-gray-700/50 p-6 hover:shadow-lg transition-all duration-200">
                <div className="flex items-center space-x-3 mb-4">
                  ...
                  <h3 className="text-lg font-bold text-white tracking-tight">Monthly Performance</h3>
                </div>
                <ResponsiveContainer width="100%" height={200}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            ...
            <div className="bg-gray-800/90 backdrop-blur-sm rounded-2xl shadow-sm border border-gray-700/50 p-5 hover:shadow-xl hover:shadow-gray-700/50 transition-all duration-300 cursor-pointer group transform hover:-translate-y-2 hover:rotate-1"
              ...
              <div className="flex items-start justify-between mb-4">
                ...
                <div className="text-right">
                  <span className="text-xs font-bold text-gray-300 bg-gray-700 px-3 py-1 rounded-full border border-gray-600">$0.30</span>
                  <p className="text-xs text-gray-500 mt-1">per comment</p>
                </div>
              </div>
              <h3 className="font-bold text-white mb-3 group-hover:text-gray-300 transition-colors duration-200 text-lg">Comment Writing</h3>
              <p className="text-sm text-gray-300 mb-4 leading-relaxed">Spark authentic conversations on Reddit, Twitter, and beyond with human-crafted responses.</p>
              <div className="flex items-center justify-between">
                <span className="bg-gradient-to-r from-gray-700 to-gray-600 text-gray-200 px-3 py-1 rounded-full text-xs font-medium border border-gray-600">Engagement</span>
                <span className="text-xs text-gray-500 group-hover:text-gray-300 transition-colors">→ Start</span>
              </div>
            </div>
            ...
            <div className="bg-gray-800/90 backdrop-blur-sm rounded-2xl shadow-sm border border-gray-700/50 p-5 hover:shadow-xl hover:shadow-gray-700/50 transition-all duration-300 cursor-pointer group transform hover:-translate-y-2 hover:-rotate-1"
              ...
              <div className="flex items-start justify-between mb-4">
                ...
                <div className="text-right">
                  <span className="text-xs font-bold text-gray-300 bg-gray-700 px-3 py-1 rounded-full border border-gray-600">FREE</span>
                  <p className="text-xs text-gray-500 mt-1">unlimited</p>
                </div>
              </div>
              <h3 className="font-bold text-white mb-3 group-hover:text-gray-300 transition-colors duration-200 text-lg">Product Research</h3>
              <p className="text-sm text-gray-300 mb-4 leading-relaxed">Discover trending conversations and market opportunities across social platforms.</p>
              <div className="flex items-center justify-between">
                <span className="bg-gradient-to-r from-gray-700 to-gray-600 text-gray-200 px-3 py-1 rounded-full text-xs font-medium border border-gray-600">Discovery</span>
                <span className="text-xs text-gray-500 group-hover:text-gray-300 transition-colors">→ Explore</span>
              </div>
            </div>
